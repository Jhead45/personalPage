                    ...
                    <div className="col-md-12 pl-0  w-100 pr-0">
                        <table className="table table-striped table-sm-responsive  displayColor2 mb-0 w-100">
                            <tbody>
                                <tr>
                                    <td colSpan="2">
                                        <h1 className="font-weight-bold mb-0 text-center">
                                            Look Up A Job
                                        </h1>
                                    </td>
                                </tr>
                        ...
                        <div className="mt-0">
                            <input
                                onChange={(e) => this.handleJob(e.target.value)}
                                placeholder="Search by Job Name"
                                type="text"
                                className="form-control addBorders h-100 "
                                required
                            />
                            <button
                                className="btn-block btn-primary mt-0 border-2 border-dark"
                    ...
                    <StripeProvider apiKey="pk_test_x6JIHgC2syqeznKhToq8o3xs">
                        <Elements>
                            <InjectedCheckoutForm
                                value={this.state.job.amountDue}
                            />
                        </Elements>
                    </StripeProvider>
                </div>
