        ...
        case 'Blog Spot!':
            ...
            <Fragment>
                ...
                <div className=' col-md-4 myColor d-flex flex-column justify-content-center align-items-center'>
                    ...
                    <a href='https://floating-tundra-51790.herokuapp.com/' target='_blank' className='btn btn-primary  '><p>View Site</p></a>
        ...
        case 'Chirper!':
                ...
                <Fragment>
                    <div className='col-md-6 d-flex justify-content-center align-items-center'>
                        ...
                        <div className=' col-md-4 myColor d-flex flex-column justify-content-center align-items-center'>
                            <h1>Chirper!</h1>
                            <p>This project was completed using ReactJS, NodeJS / Express, and MySQL.<br />
                            ...
                            database and accessed with API calls. No authentication was used in this project in order to demonstrate functionality.</p><br />
                            <a href='https://agile-retreat-61795.herokuapp.com/' target='_blank' className='btn btn-primary '><p>View Site</p></a>
        ...
        default:
                return(
                    ...
                    <div className='col-md-10 myColor d-flex justify-content-center align-items-center'>
                        <h1 className='w-100'>Click Section to View Previous Projects.</h1>
                    </div>
                    </Fragment>)
    }
